...
class ViewController: UIViewController, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let array = moviesArray[indexPath.row]
        
        cell.mainImageView.image = array.movieImage
        cell.movieNameLabel.text = array.movieName
        cell.descriptionLabel.text = array.movieDescription
